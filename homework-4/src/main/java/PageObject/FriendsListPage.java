...
public class FriendsListPage {
    ...
    private final By friendRequestStatusText = By.xpath(".//span[@class='lstp-t ellip']");//После обновления страницы где мы находим друзей мнеяется с "Запрос отправлен" на "Заявка отправлена"
    ...
    //Проверку каждой из страниц я делаю по элементам из разных
